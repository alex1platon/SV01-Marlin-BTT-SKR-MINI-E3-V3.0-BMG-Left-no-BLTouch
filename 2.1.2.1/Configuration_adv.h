...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  33.11          // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.25f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  46.8          // (Hz) The default dominant resonant frequency on the Y axis.
